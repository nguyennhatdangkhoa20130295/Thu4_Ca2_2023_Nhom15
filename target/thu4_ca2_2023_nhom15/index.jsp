                            ...
                            <div class="card-body p-0 me-lg-5">
                                <p class="fw-500 text-grey-500 lh-26 font-xssss w-100">Lorem ipsum dolor sit amet,
                                    ...
                                    nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus <a
                                            href="#" class="fw-600 text-primary ms-2">Xem thêm</a></p>
                            </div>
                            ...
                            <div class="card-body d-flex p-0 mt-3">
                                ...
                                <a href="#"
                                   class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i
                                        ...
                                        class="d-none-xss">22 Bình luận</span></a>
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg"
                                    ...
                                    <h4 class="fw-700 font-xss text-grey-900 d-flex align-items-center">Chia sẻ <i
                        ...
                        <div class="card w-100 shadow-none bg-transparent bg-transparent-card border-0 p-0 mb-0">
                            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none owl-loaded owl-drag">
                                ...
                                <div class="owl-stage-outer">
                                    <div class="owl-stage"
                                         style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 825px;">
                                                ...
                                                <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 me-2 mt-3">
                                                    <div class="card-body d-block w-100 ps-3 pe-3 pb-4 text-center">
                                                        <figure class="avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                                                            <img src="http://uitheme.net/sociala/images/user-11.png"
                                                                 alt="image"
                                        ...
                                        <div class="owl-item active" style="width: auto; margin-right: 7px;">
                                            <div class="item">
                                                <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 me-2 mt-3">
                                                    <div class="card-body d-block w-100 ps-3 pe-3 pb-4 text-center">
                                                        <figure class="avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                                                            <img src="http://uitheme.net/sociala/images/user-9.png"
                                                                 alt="image"
                                                                 class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"
                                                                 style="opacity: 1;"></figure>
                                                        <div class="clearfix"></div>
                                        ...
                                        <div class="owl-item active" style="width: auto; margin-right: 7px;">
                                            <div class="item">
                                                <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 me-2 mt-3">
                                                    <div class="card-body d-block w-100 ps-3 pe-3 pb-4 text-center">
                                                        <figure class="avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                                                            <img src="http://uitheme.net/sociala/images/user-12.png"
                                                                 alt="image"
                                                                 class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"
                                                                 style="opacity: 1;"></figure>
                                                        <div class="clearfix"></div>
                                        ...
                                        <div class="owl-item active" style="width: auto; margin-right: 7px;">
                                            <div class="item">
                                                <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 me-2 mt-3">
                                                    <div class="card-body d-block w-100 ps-3 pe-3 pb-4 text-center">
                                                        <figure class="avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                                                            <img src="http://uitheme.net/sociala/images/user-8.png"
                                                                 alt="image"
                                                                 class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"
                                                                 style="opacity: 1;"></figure>
                                                        <div class="clearfix"></div>
                                        ...
                                        <div class="owl-item" style="width: auto; margin-right: 7px;">
                                            <div class="item">
                                                <div class="card w150 d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 me-2 mt-3">
                                                    <div class="card-body d-block w-100 ps-3 pe-3 pb-4 text-center">
                                                        <figure class="avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                                                            <img src="http://uitheme.net/sociala/images/user-7.png"
                                                                 alt="image"
                                                                 class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"
                                                                 style="opacity: 1;"></figure>
                                                        <div class="clearfix"></div>
