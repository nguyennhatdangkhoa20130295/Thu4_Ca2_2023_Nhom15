                ...
                <div class="card-body rounded-0 text-left">
                    ...
                    <form action="register" method="post">
                        ...
                        <div class="form-group icon-input mb-3">
                            ...
                            <%} else {%>
                            <div class="note"><span>Sử dụng 8 ký tự trở lên với ít nhất một chữ cái viết hoa, một chữ cái viết thường, một số và một ký tự đặc biệt</span></div>
                            <%}%>
                        </div>
                        <div class="form-group icon-input mb-3">
                    ...
                    <div class="card-body rounded-0 text-left p-3">
                        ...
                        <form>
                            ...
                            <div class="form-check text-left mb-3">
                                ...
                                <label class="form-check-label font-xsss text-grey-500" for="exampleCheck7">Accept Term
                        ...
                        <div class="col-sm-12 p-0 text-left">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Already have account <a
                                    href="login.jsp" class="fw-700 ms-1">Login</a></h6>
                        </div>
                        <div class="col-sm-12 p-0 text-center mt-3 ">
